...
export default function AdminDashboardPage() {
  return (
    <>
      <Head>
        <title>Painel Administrativo - PolicyLabs APSS</title>
      ...
      <nav className="card-glass fixed top-0 w-full z-50 px-6 py-4">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold">PolicyLabs Admin</span>
          </div>

          <div className="flex items-center space-x-4">
            <span className="text-sm">👨‍💼 Administrador</span>
            <Link href="/admin/profile" className="btn-glass">Perfil</Link>
