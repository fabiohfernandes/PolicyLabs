      ...
      <header className="bg-white/25 dark:bg-white/5 backdrop-blur-sm border border-white/30 dark:border-white/10 rounded-2xl mx-6 mt-4 px-6 py-4">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="flex items-center">
            <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Quem está colhendo resultados</h1>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="card-glass p-8">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Município de Inovação - SP</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">45.000 habitantes • Plano Professional</p>
                </div>
              </div>

              <div className="mb-6">
                <h4 className="font-semibold mb-2 text-green-600 dark:text-green-400">Resultados Alcançados:</h4>
              ...
              <blockquote className="border-l-4 border-blue-500 dark:border-blue-400 pl-4 italic text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="card-glass p-8">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Verde Sustentável - MG</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">78.000 habitantes • Plano Enterprise</p>
                </div>
              </div>
              ...
              <blockquote className="border-l-4 border-green-500 dark:border-green-400 pl-4 italic text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="card-glass p-8">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Dados Inteligentes - RS</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">120.000 habitantes • Plano Enterprise</p>
                </div>
              </div>
              ...
              <blockquote className="border-l-4 border-purple-500 dark:border-purple-400 pl-4 italic text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="card-glass p-8">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Participação Cidadã - PR</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">32.000 habitantes • Plano Starter</p>
                </div>
              </div>
              ...
              <blockquote className="border-l-4 border-orange-500 dark:border-orange-400 pl-4 italic text-gray-600 dark:text-gray-300 mb-4">
        ...
        <section className="mx-6 mt-16">
          <div className="card-glass p-12 text-center">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">127</div>
                <div className="text-gray-600 dark:text-gray-400">Municípios Atendidos</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-green-600 dark:text-green-400 mb-2">85%</div>
                <div className="text-gray-600 dark:text-gray-400">Taxa de Sucesso Prevista</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2">R$ 47M</div>
                <div className="text-gray-600 dark:text-gray-400">Economias Geradas</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-orange-600 dark:text-orange-400 mb-2">2.3M</div>
                <div className="text-gray-600 dark:text-gray-400">Cidadãos Beneficiados</div>
              </div>
            </div>
          </div>
        </section>
